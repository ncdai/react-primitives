...
import {
  ...
  PopoverContent,
  PopoverTrigger,
} from "@/components/fumadocs/popover"
...
// Upstream shares this component with Vite, where reading `import.meta.env`
// needs suppression directives. Next.js types it fine and has no base path.
